...
export const ALL_BADGES: Badge[] = [
  ...
  { id: 'yellowstone-wolf', name: 'Wolf Watcher', description: 'Spot the Gray Wolf at Yellowstone.', category: 'special', earned: false, progress: 0, goal: 1 },
  { id: 'pinnacles-condor', name: 'Condor Companion', description: 'Spot the California Condor at Pinnacles.', category: 'special', earned: false, progress: 0, goal: 1 },
  { id: 'everglades-manatee', name: 'Seeking Sea Cows', description: 'Spot the Manatee at Everglades.', category: 'special', earned: false, progress: 0, goal: 1 },
  { id: 'half-dome', name: 'Cable Climber', description: 'Complete the Half Dome trail at Yosemite.', category: 'special', earned: false, progress: 0, goal: 1 },
