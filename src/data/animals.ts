...
export const ALL_ANIMALS: Animal[] = [
  ...
  { id: 'yellowstone-pronghorn', parkId: 'yellowstone', name: 'Pronghorn', description: 'Common on the open grasslands of the Lamar and Hayden valleys.', rarity: 'Common' },
  { id: 'yellowstone-osprey', parkId: 'yellowstone', name: 'Osprey', description: "Nests along the cliffs of the Yellowstone River canyon.", rarity: 'Uncommon' },
  { id: 'yellowstone-moose', parkId: 'yellowstone', name: 'Moose', description: 'Found browsing willow wetlands near park rivers, though numbers have declined.', rarity: 'Uncommon' },
  { id: 'yellowstone-trumpeter-swan', parkId: 'yellowstone', name: 'Trumpeter Swan', description: 'Rare native waterfowl seen on quiet park lakes and rivers.', rarity: 'Rare' },
  ...
  { id: 'zion-mountain-lion', parkId: 'zion', name: 'Mountain Lion', description: 'Elusive predator roaming the high plateaus above the canyon.', rarity: 'Rare' },
  { id: 'zion-wild-turkey', parkId: 'zion', name: 'Wild Turkey', description: 'Forages the canyon floor near the Virgin River.', rarity: 'Common' },
  { id: 'zion-ringtail', parkId: 'zion', name: 'Ringtail', description: 'Nocturnal, rarely seen scaling the canyon\'s sheer walls.', rarity: 'Rare' },
  { id: 'zion-golden-eagle', parkId: 'zion', name: 'Golden Eagle', description: 'Soars above the canyon rim hunting for small mammals.', rarity: 'Uncommon' },
  ...
  { id: 'rocky-mountain-mountain-lion', parkId: 'rocky-mountain', name: 'Mountain Lion', description: 'Elusive predator of the montane forests, rarely seen by visitors.', rarity: 'Rare' },
  { id: 'rocky-mountain-yellow-bellied-marmot', parkId: 'rocky-mountain', name: 'Yellow-Bellied Marmot', description: 'Common sunning on rocks near alpine trails and lakes.', rarity: 'Common' },
  { id: 'rocky-mountain-coyote', parkId: 'rocky-mountain', name: 'Coyote', description: 'Frequently seen trotting through meadows at dawn and dusk.', rarity: 'Common' },
  { id: 'rocky-mountain-clarks-nutcracker', parkId: 'rocky-mountain', name: "Clark's Nutcracker", description: 'Bold gray bird common near treeline and alpine overlooks.', rarity: 'Uncommon' },
  ...
  { id: 'yosemite-coyote', parkId: 'yosemite', name: 'Coyote', description: 'Often seen trotting across meadows at dawn.', rarity: 'Common' },
  { id: 'yosemite-great-gray-owl', parkId: 'yosemite', name: 'Great Gray Owl', description: 'Rare owl found hunting in the park\'s high-elevation meadows.', rarity: 'Rare' },
  { id: 'yosemite-mountain-lion', parkId: 'yosemite', name: 'Mountain Lion', description: 'Elusive predator of the high country and forested slopes.', rarity: 'Rare' },
  { id: 'yosemite-stellers-jay', parkId: 'yosemite', name: "Steller's Jay", description: 'Bold blue-crested bird common at campgrounds and trailheads.', rarity: 'Common' },
  ...
  { id: 'grand-canyon-ringtail', parkId: 'grand-canyon', name: 'Ringtail', description: 'Nocturnal, seldom-seen scavenger of the inner canyon.', rarity: 'Rare' },
  { id: 'grand-canyon-raven', parkId: 'grand-canyon', name: 'Common Raven', description: 'Bold scavenger seen at nearly every overlook.', rarity: 'Common' },
  { id: 'grand-canyon-desert-tortoise', parkId: 'grand-canyon', name: 'Desert Tortoise', description: 'Found in the lower desert scrub near the Colorado River.', rarity: 'Uncommon' },
  { id: 'grand-canyon-pronghorn', parkId: 'grand-canyon', name: 'Pronghorn', description: 'Grazes the plateau grasslands near the South Rim entrance.', rarity: 'Uncommon' },
  ...
  { id: 'grand-teton-black-bear', parkId: 'grand-teton', name: 'Black Bear', description: 'Forages berry patches in aspen groves through late summer.', rarity: 'Uncommon' },
  { id: 'grand-teton-osprey', parkId: 'grand-teton', name: 'Osprey', description: 'Dives for fish along the Snake River.', rarity: 'Uncommon' },
  { id: 'grand-teton-coyote', parkId: 'grand-teton', name: 'Coyote', description: 'Common across the sagebrush flats below the Tetons.', rarity: 'Common' },
  { id: 'grand-teton-trumpeter-swan', parkId: 'grand-teton', name: 'Trumpeter Swan', description: 'Nests on Oxbow Bend and other quiet park ponds.', rarity: 'Rare' },
  ...
  { id: 'acadia-porcupine', parkId: 'acadia', name: 'North American Porcupine', description: "Common in the park's spruce-fir forest, often seen high in trees.", rarity: 'Common' },
  ...
  { id: 'great-smoky-river-otter', parkId: 'great-smoky', name: 'River Otter', description: "Reintroduced, occasionally seen along the park's larger streams.", rarity: 'Rare' },
  { id: 'great-smoky-black-throated-blue-warbler', parkId: 'great-smoky', name: 'Black-Throated Blue Warbler', description: 'Common summer songbird of the high-elevation forest.', rarity: 'Common' },
  { id: 'great-smoky-timber-rattlesnake', parkId: 'great-smoky', name: 'Timber Rattlesnake', description: 'Found among rocky outcrops on sunny ridgelines.', rarity: 'Uncommon' },
  { id: 'great-smoky-bobcat', parkId: 'great-smoky', name: 'Bobcat', description: 'Elusive nocturnal predator of the forest understory.', rarity: 'Rare' },
  ...
  { id: 'arches-desert-cottontail', parkId: 'arches', name: 'Desert Cottontail', description: 'Common around campgrounds and picnic areas.', rarity: 'Common' },
  { id: 'arches-peregrine-falcon', parkId: 'arches', name: 'Peregrine Falcon', description: 'Nests on high sandstone cliffs above the desert.', rarity: 'Rare' },
  { id: 'arches-midget-faded-rattlesnake', parkId: 'arches', name: 'Midget Faded Rattlesnake', description: 'Small venomous snake found basking on sunny slickrock.', rarity: 'Uncommon' },
  { id: 'arches-raven', parkId: 'arches', name: 'Common Raven', description: 'Frequent scavenger seen soaring above the sandstone fins.', rarity: 'Common' },
  ...
  { id: 'shenandoah-bobcat', parkId: 'shenandoah', name: 'Bobcat', description: 'Elusive predator of the forested hollows.', rarity: 'Rare' },
  { id: 'shenandoah-copperhead', parkId: 'shenandoah', name: 'Copperhead', description: 'Found among rocky ledges and leaf litter.', rarity: 'Uncommon' },
  { id: 'shenandoah-ruffed-grouse', parkId: 'shenandoah', name: 'Ruffed Grouse', description: 'Forest bird known for its drumming display in spring.', rarity: 'Common' },
  { id: 'shenandoah-coyote', parkId: 'shenandoah', name: 'Coyote', description: 'Increasingly common across the Blue Ridge.', rarity: 'Uncommon' },
  ...
  { id: 'new-river-gorge-copperhead', parkId: 'new-river-gorge', name: 'Copperhead', description: 'Found sunning on rock ledges above the gorge.', rarity: 'Uncommon' },
  { id: 'new-river-gorge-peregrine-falcon', parkId: 'new-river-gorge', name: 'Peregrine Falcon', description: "Nests on the gorge's sandstone cliffs.", rarity: 'Rare' },
  { id: 'new-river-gorge-belted-kingfisher', parkId: 'new-river-gorge', name: 'Belted Kingfisher', description: 'Dives for fish along the New River.', rarity: 'Common' },
  { id: 'new-river-gorge-black-vulture', parkId: 'new-river-gorge', name: 'Black Vulture', description: 'Soars above the gorge rim on broad wings.', rarity: 'Common' },
  ...
  { id: 'biscayne-bottlenose-dolphin', parkId: 'biscayne', name: 'Bottlenose Dolphin', description: "Frequently seen in the bay's shallow channels.", rarity: 'Common' },
  { id: 'biscayne-spotted-eagle-ray', parkId: 'biscayne', name: 'Spotted Eagle Ray', description: 'Glides gracefully over seagrass beds.', rarity: 'Uncommon' },
  { id: 'biscayne-green-sea-turtle', parkId: 'biscayne', name: 'Green Sea Turtle', description: 'Grazes seagrass meadows throughout the bay.', rarity: 'Uncommon' },
  ...
  { id: 'dry-tortugas-brown-pelican', parkId: 'dry-tortugas', name: 'Brown Pelican', description: "Dives for fish near the fort's moat wall.", rarity: 'Common' },
  { id: 'dry-tortugas-nurse-shark', parkId: 'dry-tortugas', name: 'Nurse Shark', description: "Seen resting on the sea floor around the fort's pilings.", rarity: 'Uncommon' },
  { id: 'dry-tortugas-brown-noddy', parkId: 'dry-tortugas', name: 'Brown Noddy', description: 'Seabird that nests alongside sooty terns on Bush Key.', rarity: 'Uncommon' },
  ...
  { id: 'everglades-wood-stork', parkId: 'everglades', name: 'Wood Stork', description: 'Endangered wading bird that nests in cypress domes.', rarity: 'Rare' },
  { id: 'everglades-anhinga', parkId: 'everglades', name: 'Anhinga', description: 'Common fish-hunting bird seen drying its wings in the sun.', rarity: 'Common' },
  { id: 'everglades-burmese-python', parkId: 'everglades', name: 'Burmese Python', description: "Invasive species that has reshaped the park's food web.", rarity: 'Uncommon' },
  { id: 'everglades-snail-kite', parkId: 'everglades', name: 'Snail Kite', description: 'Rare raptor that feeds almost exclusively on apple snails.', rarity: 'Rare' },
  ...
  { id: 'congaree-pileated-woodpecker', parkId: 'congaree', name: 'Pileated Woodpecker', description: 'Large, striking woodpecker common in the old-growth canopy.', rarity: 'Common' },
  { id: 'congaree-bobcat', parkId: 'congaree', name: 'Bobcat', description: 'Elusive predator of the floodplain forest.', rarity: 'Rare' },
  { id: 'congaree-yellow-bellied-slider', parkId: 'congaree', name: 'Yellow-Bellied Slider', description: 'Turtle commonly seen basking on logs in Weston Lake.', rarity: 'Common' },
  ...
  { id: 'mammoth-cave-eastern-woodrat', parkId: 'mammoth-cave', name: 'Eastern Woodrat', description: 'Found near cave entrances, known for collecting shiny objects.', rarity: 'Uncommon' },
  { id: 'mammoth-cave-northern-cavefish', parkId: 'mammoth-cave', name: 'Northern Cavefish', description: "Blind, colorless fish found in the cave's underground streams.", rarity: 'Rare' },
  { id: 'mammoth-cave-coyote', parkId: 'mammoth-cave', name: 'Coyote', description: "Common in the park's surface forest.", rarity: 'Common' },
  ...
  { id: 'virgin-islands-hermit-crab', parkId: 'virgin-islands', name: 'Caribbean Hermit Crab', description: 'Common scavenger found along beaches and forest trails.', rarity: 'Common' },
  { id: 'virgin-islands-brown-booby', parkId: 'virgin-islands', name: 'Brown Booby', description: 'Seabird that dives for fish off rocky offshore cays.', rarity: 'Uncommon' },
  { id: 'virgin-islands-donkey', parkId: 'virgin-islands', name: 'Wild Donkey', description: 'Descended from colonial-era pack animals, roams the island roads.', rarity: 'Common' },
  ...
  { id: 'cuyahoga-valley-bald-eagle', parkId: 'cuyahoga-valley', name: 'Bald Eagle', description: 'Nests along the Cuyahoga River.', rarity: 'Uncommon' },
  { id: 'cuyahoga-valley-red-fox', parkId: 'cuyahoga-valley', name: 'Red Fox', description: 'Found in meadows and forest edges throughout the valley.', rarity: 'Common' },
  { id: 'cuyahoga-valley-wood-duck', parkId: 'cuyahoga-valley', name: 'Wood Duck', description: "Colorful duck found in the park's wetlands.", rarity: 'Uncommon' },
  ...
  { id: 'indiana-dunes-red-fox', parkId: 'indiana-dunes', name: 'Red Fox', description: 'Dens among the dune grasses and oak savanna.', rarity: 'Uncommon' },
  { id: 'indiana-dunes-blandings-turtle', parkId: 'indiana-dunes', name: "Blanding's Turtle", description: "Rare turtle found in the park's wetlands.", rarity: 'Rare' },
  { id: 'indiana-dunes-monarch-butterfly', parkId: 'indiana-dunes', name: 'Monarch Butterfly', description: 'Passes through during fall migration along the lakeshore.', rarity: 'Uncommon' },
  ...
  { id: 'isle-royale-snowshoe-hare', parkId: 'isle-royale', name: 'Snowshoe Hare', description: "A common prey species in the island's boreal forest.", rarity: 'Common' },
  { id: 'isle-royale-mink', parkId: 'isle-royale', name: 'Mink', description: "Found along the island's rocky shoreline.", rarity: 'Uncommon' },
  { id: 'isle-royale-merlin', parkId: 'isle-royale', name: 'Merlin', description: 'Small falcon seen hunting over open rock outcrops.', rarity: 'Rare' },
  ...
  { id: 'voyageurs-river-otter', parkId: 'voyageurs', name: 'River Otter', description: "Plays in the park's interconnected waterways.", rarity: 'Uncommon' },
  { id: 'voyageurs-moose', parkId: 'voyageurs', name: 'Moose', description: 'Found browsing wetlands across the peninsula.', rarity: 'Uncommon' },
  { id: 'voyageurs-osprey', parkId: 'voyageurs', name: 'Osprey', description: 'Nests on rocky islands throughout the park\'s lakes.', rarity: 'Common' },
  ...
  { id: 'wind-cave-coyote', parkId: 'wind-cave', name: 'Coyote', description: 'Common across the mixed-grass prairie.', rarity: 'Common' },
  { id: 'wind-cave-golden-eagle', parkId: 'wind-cave', name: 'Golden Eagle', description: "Soars above the park's rolling grasslands.", rarity: 'Uncommon' },
  { id: 'wind-cave-cave-cricket', parkId: 'wind-cave', name: 'Cave Cricket', description: "Found deep within the cave's dark passages.", rarity: 'Uncommon' },
  ...
  { id: 'badlands-golden-eagle', parkId: 'badlands', name: 'Golden Eagle', description: 'Soars above the eroded buttes and pinnacles.', rarity: 'Uncommon' },
  { id: 'badlands-mule-deer', parkId: 'badlands', name: 'Mule Deer', description: 'Common throughout the badlands formations.', rarity: 'Common' },
  { id: 'badlands-coyote', parkId: 'badlands', name: 'Coyote', description: 'Frequently seen trotting across the grasslands.', rarity: 'Common' },
  ...
  { id: 'theodore-roosevelt-coyote', parkId: 'theodore-roosevelt', name: 'Coyote', description: 'Common across the badlands grasslands.', rarity: 'Common' },
  { id: 'theodore-roosevelt-mule-deer', parkId: 'theodore-roosevelt', name: 'Mule Deer', description: "Found in the park's wooded draws and coulees.", rarity: 'Common' },
  { id: 'theodore-roosevelt-golden-eagle', parkId: 'theodore-roosevelt', name: 'Golden Eagle', description: "Nests on the park's badlands buttes.", rarity: 'Uncommon' },
  ...
  { id: 'big-bend-peregrine-falcon', parkId: 'big-bend', name: 'Peregrine Falcon', description: 'Nests on the cliffs of the Chisos Mountains.', rarity: 'Rare' },
  { id: 'big-bend-tarantula', parkId: 'big-bend', name: 'Tarantula', description: 'Common desert arachnid seen crossing roads in fall.', rarity: 'Common' },
  { id: 'big-bend-gray-fox', parkId: 'big-bend', name: 'Gray Fox', description: 'Nocturnal predator found in desert washes.', rarity: 'Uncommon' },
  ...
  { id: 'guadalupe-mountains-black-bear', parkId: 'guadalupe-mountains', name: 'Black Bear', description: "Occasionally seen in the park's high forested canyons.", rarity: 'Rare' },
  { id: 'guadalupe-mountains-ringtail', parkId: 'guadalupe-mountains', name: 'Ringtail', description: 'Nocturnal mammal found near rocky canyon walls.', rarity: 'Rare' },
  { id: 'guadalupe-mountains-javelina', parkId: 'guadalupe-mountains', name: 'Javelina', description: 'Forages the lower desert washes.', rarity: 'Common' },
  ...
  { id: 'hot-springs-gray-fox', parkId: 'hot-springs', name: 'Gray Fox', description: 'Nocturnal predator of the Ouachita forest.', rarity: 'Uncommon' },
  { id: 'hot-springs-eastern-fence-lizard', parkId: 'hot-springs', name: 'Eastern Fence Lizard', description: 'Common lizard basking on sunny rocks and logs.', rarity: 'Common' },
  { id: 'hot-springs-coyote', parkId: 'hot-springs', name: 'Coyote', description: 'Occasionally heard in the surrounding hills at night.', rarity: 'Uncommon' },
  ...
  { id: 'gateway-arch-red-tailed-hawk', parkId: 'gateway-arch', name: 'Red-Tailed Hawk', description: 'Occasionally seen soaring above the arch grounds.', rarity: 'Uncommon' },
  { id: 'gateway-arch-canada-goose', parkId: 'gateway-arch', name: 'Canada Goose', description: 'Common along the riverfront lawns.', rarity: 'Common' },
  { id: 'gateway-arch-common-carp', parkId: 'gateway-arch', name: 'Common Carp', description: 'Seen in the shallows of the Mississippi River.', rarity: 'Common' },
  ...
  { id: 'black-canyon-elk', parkId: 'black-canyon', name: 'Elk', description: 'Found in meadows along both canyon rims.', rarity: 'Uncommon' },
  { id: 'black-canyon-red-tailed-hawk', parkId: 'black-canyon', name: 'Red-Tailed Hawk', description: 'Hunts small mammals along the canyon rim.', rarity: 'Common' },
  { id: 'black-canyon-gunnison-sage-grouse', parkId: 'black-canyon', name: 'Gunnison Sage-Grouse', description: 'Rare grouse found in nearby sagebrush habitat.', rarity: 'Rare' },
  ...
  { id: 'great-sand-dunes-mule-deer', parkId: 'great-sand-dunes', name: 'Mule Deer', description: "Found in the grasslands surrounding the dunefield.", rarity: 'Common' },
  { id: 'great-sand-dunes-golden-eagle', parkId: 'great-sand-dunes', name: 'Golden Eagle', description: 'Soars above the Sangre de Cristo foothills.', rarity: 'Uncommon' },
  { id: 'great-sand-dunes-bighorn-sheep', parkId: 'great-sand-dunes', name: 'Bighorn Sheep', description: 'Found in the high mountains bordering the park.', rarity: 'Rare' },
  ...
  { id: 'mesa-verde-mountain-lion', parkId: 'mesa-verde', name: 'Mountain Lion', description: 'Elusive predator of the surrounding canyon country.', rarity: 'Rare' },
  { id: 'mesa-verde-canyon-towhee', parkId: 'mesa-verde', name: 'Canyon Towhee', description: 'Common ground-foraging bird of the pinyon-juniper woodland.', rarity: 'Common' },
  { id: 'mesa-verde-gopher-snake', parkId: 'mesa-verde', name: 'Gopher Snake', description: 'Found sunning on trails throughout the mesa.', rarity: 'Uncommon' },
  ...
  { id: 'bryce-canyon-mountain-lion', parkId: 'bryce-canyon', name: 'Mountain Lion', description: 'Elusive predator of the plateau forest.', rarity: 'Rare' },
  { id: 'bryce-canyon-golden-mantled-squirrel', parkId: 'bryce-canyon', name: 'Golden-Mantled Ground Squirrel', description: 'Common near overlooks and picnic areas.', rarity: 'Common' },
  { id: 'bryce-canyon-clarks-nutcracker', parkId: 'bryce-canyon', name: "Clark's Nutcracker", description: "Bold bird seen near the rim's ponderosa pines.", rarity: 'Uncommon' },
  ...
  { id: 'canyonlands-mule-deer', parkId: 'canyonlands', name: 'Mule Deer', description: 'Found among pinyon-juniper woodlands.', rarity: 'Common' },
  { id: 'canyonlands-raven', parkId: 'canyonlands', name: 'Common Raven', description: 'Frequent scavenger seen soaring above the canyons.', rarity: 'Common' },
  { id: 'canyonlands-midget-faded-rattlesnake', parkId: 'canyonlands', name: 'Midget Faded Rattlesnake', description: 'Small venomous snake found on desert slickrock.', rarity: 'Uncommon' },
  ...
  { id: 'capitol-reef-golden-eagle', parkId: 'capitol-reef', name: 'Golden Eagle', description: "Nests on the reef's sandstone cliffs.", rarity: 'Uncommon' },
  { id: 'capitol-reef-porcupine', parkId: 'capitol-reef', name: 'Porcupine', description: 'Found among cottonwoods in the historic orchards.', rarity: 'Uncommon' },
  { id: 'capitol-reef-rock-squirrel', parkId: 'capitol-reef', name: 'Rock Squirrel', description: 'Common around the historic orchard area.', rarity: 'Common' },
  ...
  { id: 'glacier-hoary-marmot', parkId: 'glacier', name: 'Hoary Marmot', description: "Whistles from rockslides in the park's high country.", rarity: 'Common' },
  { id: 'glacier-wolverine', parkId: 'glacier', name: 'Wolverine', description: 'Rare, elusive predator of the high alpine.', rarity: 'Rare' },
  { id: 'glacier-golden-eagle', parkId: 'glacier', name: 'Golden Eagle', description: 'Soars above mountain passes during fall migration.', rarity: 'Uncommon' },
  ...
  { id: 'glacier-bay-mountain-goat', parkId: 'glacier-bay', name: 'Mountain Goat', description: 'Found on steep slopes above the bay.', rarity: 'Uncommon' },
  { id: 'glacier-bay-harbor-seal', parkId: 'glacier-bay', name: 'Harbor Seal', description: 'Hauls out on icebergs near tidewater glaciers.', rarity: 'Common' },
  { id: 'glacier-bay-steller-sea-lion', parkId: 'glacier-bay', name: 'Steller Sea Lion', description: "Hauls out on rocky sites near the bay's mouth.", rarity: 'Uncommon' },
  ...
  { id: 'petrified-forest-golden-eagle', parkId: 'petrified-forest', name: 'Golden Eagle', description: 'Soars above the Painted Desert badlands.', rarity: 'Uncommon' },
  { id: 'petrified-forest-horned-lizard', parkId: 'petrified-forest', name: 'Greater Short-Horned Lizard', description: "Found among the park's grassland and badlands.", rarity: 'Uncommon' },
  { id: 'petrified-forest-kit-fox', parkId: 'petrified-forest', name: 'Kit Fox', description: 'Small nocturnal fox of the desert grasslands.', rarity: 'Rare' },
  ...
  { id: 'saguaro-coyote', parkId: 'saguaro', name: 'Coyote', description: 'Common throughout the Sonoran Desert scrub.', rarity: 'Common' },
  { id: 'saguaro-harris-hawk', parkId: 'saguaro', name: "Harris's Hawk", description: 'Social raptor often seen hunting cooperatively in groups.', rarity: 'Uncommon' },
  { id: 'saguaro-cactus-wren', parkId: 'saguaro', name: 'Cactus Wren', description: "Arizona's state bird, often seen nesting within cholla and saguaro spines.", rarity: 'Common' },
  ...
  { id: 'carlsbad-caverns-desert-cottontail', parkId: 'carlsbad-caverns', name: 'Desert Cottontail', description: 'Common in the surface scrub near the visitor center.', rarity: 'Common' },
  { id: 'carlsbad-caverns-rock-rattlesnake', parkId: 'carlsbad-caverns', name: 'Rock Rattlesnake', description: 'Found among rocky desert outcrops.', rarity: 'Uncommon' },
  { id: 'carlsbad-caverns-black-bear', parkId: 'carlsbad-caverns', name: 'Black Bear', description: 'Occasionally wanders down from the Guadalupe highlands.', rarity: 'Rare' },
  ...
  { id: 'white-sands-coyote', parkId: 'white-sands', name: 'Coyote', description: 'Hunts across the gypsum dunefield at dusk.', rarity: 'Common' },
  { id: 'white-sands-tarantula-hawk-wasp', parkId: 'white-sands', name: 'Tarantula Hawk Wasp', description: 'Large wasp seen among desert shrubs bordering the dunes.', rarity: 'Uncommon' },
  { id: 'white-sands-oryx', parkId: 'white-sands', name: 'Oryx', description: 'Introduced African antelope occasionally seen near the dunefield edges.', rarity: 'Rare' },
  ...
  { id: 'great-basin-mule-deer', parkId: 'great-basin', name: 'Mule Deer', description: "Common throughout the park's sagebrush and forest.", rarity: 'Common' },
  { id: 'great-basin-pika', parkId: 'great-basin', name: 'American Pika', description: 'Found among talus slopes near Wheeler Peak.', rarity: 'Uncommon' },
  { id: 'great-basin-black-bear', parkId: 'great-basin', name: 'Black Bear', description: "Occasionally seen in the park's forested canyons.", rarity: 'Rare' },
  ...
  { id: 'sequoia-douglas-squirrel', parkId: 'sequoia', name: 'Douglas Squirrel', description: 'Common in the sequoia groves, busily collecting cones.', rarity: 'Common' },
  { id: 'sequoia-mountain-lion', parkId: 'sequoia', name: 'Mountain Lion', description: 'Elusive predator of the Sierra foothills.', rarity: 'Rare' },
  { id: 'sequoia-clarks-nutcracker', parkId: 'sequoia', name: "Clark's Nutcracker", description: 'Bold bird found near the high-elevation groves.', rarity: 'Uncommon' },
  ...
  { id: 'kings-canyon-mountain-lion', parkId: 'kings-canyon', name: 'Mountain Lion', description: "Elusive predator of the canyon's remote high country.", rarity: 'Rare' },
  { id: 'kings-canyon-douglas-squirrel', parkId: 'kings-canyon', name: 'Douglas Squirrel', description: 'Common among the giant sequoia groves.', rarity: 'Common' },
  { id: 'kings-canyon-bighorn-sheep', parkId: 'kings-canyon', name: 'Sierra Nevada Bighorn Sheep', description: "Endangered subspecies found in the park's remote high country.", rarity: 'Rare' },
  ...
  { id: 'death-valley-coyote', parkId: 'death-valley', name: 'Coyote', description: 'Commonly seen trotting across the valley floor at dawn.', rarity: 'Common' },
  { id: 'death-valley-chuckwalla', parkId: 'death-valley', name: 'Chuckwalla', description: 'Large lizard that wedges itself into rock crevices when threatened.', rarity: 'Uncommon' },
  { id: 'death-valley-raven', parkId: 'death-valley', name: 'Common Raven', description: 'Scavenger frequently seen near Badwater Basin.', rarity: 'Common' },
  ...
  { id: 'joshua-tree-coyote', parkId: 'joshua-tree', name: 'Coyote', description: 'Common throughout the high and low desert.', rarity: 'Common' },
  { id: 'joshua-tree-mojave-rattlesnake', parkId: 'joshua-tree', name: 'Mojave Rattlesnake', description: 'Venomous snake found among desert scrub.', rarity: 'Uncommon' },
  { id: 'joshua-tree-golden-eagle', parkId: 'joshua-tree', name: 'Golden Eagle', description: 'Nests on rocky outcrops within the park.', rarity: 'Rare' },
  ...
  { id: 'channel-islands-harbor-seal', parkId: 'channel-islands', name: 'Harbor Seal', description: 'Hauls out on rocky beaches throughout the islands.', rarity: 'Common' },
  { id: 'channel-islands-brown-pelican', parkId: 'channel-islands', name: 'Brown Pelican', description: "Nests on Anacapa Island's sea cliffs.", rarity: 'Uncommon' },
  { id: 'channel-islands-night-lizard', parkId: 'channel-islands', name: 'Island Night Lizard', description: 'Endemic reptile found on the southern islands.', rarity: 'Rare' },
  ...
  { id: 'pinnacles-mountain-lion', parkId: 'pinnacles', name: 'Mountain Lion', description: "Elusive predator of the park's chaparral.", rarity: 'Rare' },
  { id: 'pinnacles-acorn-woodpecker', parkId: 'pinnacles', name: 'Acorn Woodpecker', description: 'Common bird that stores acorns in tree "granaries".', rarity: 'Common' },
  { id: 'pinnacles-golden-eagle', parkId: 'pinnacles', name: 'Golden Eagle', description: "Nests on the park's volcanic rock spires.", rarity: 'Uncommon' },
  ...
  { id: 'redwood-black-tailed-deer', parkId: 'redwood', name: 'Black-Tailed Deer', description: 'Common throughout the coastal forest.', rarity: 'Common' },
  { id: 'redwood-tidepool-sculpin', parkId: 'redwood', name: 'Tidepool Sculpin', description: "Small fish found in the park's rocky tidepools.", rarity: 'Uncommon' },
  { id: 'redwood-peregrine-falcon', parkId: 'redwood', name: 'Peregrine Falcon', description: 'Nests on coastal cliffs above the redwoods.', rarity: 'Rare' },
  ...
  { id: 'lassen-volcanic-black-tailed-deer', parkId: 'lassen-volcanic', name: 'Black-Tailed Deer', description: "Common in the park's meadows and forests.", rarity: 'Common' },
  { id: 'lassen-volcanic-golden-mantled-squirrel', parkId: 'lassen-volcanic', name: 'Golden-Mantled Ground Squirrel', description: 'Common near trailheads and picnic areas.', rarity: 'Common' },
  { id: 'lassen-volcanic-peregrine-falcon', parkId: 'lassen-volcanic', name: 'Peregrine Falcon', description: "Nests on the park's volcanic cliffs.", rarity: 'Rare' },
  ...
  { id: 'olympic-black-bear', parkId: 'olympic', name: 'Black Bear', description: "Forages the park's forests and subalpine meadows.", rarity: 'Uncommon' },
  { id: 'olympic-mountain-goat', parkId: 'olympic', name: 'Mountain Goat', description: "Non-native population found on the park's high peaks.", rarity: 'Uncommon' },
  { id: 'olympic-spotted-owl', parkId: 'olympic', name: 'Northern Spotted Owl', description: "Threatened species found in the park's old-growth forest.", rarity: 'Rare' },
  ...
  { id: 'mount-rainier-black-tailed-deer', parkId: 'mount-rainier', name: 'Black-Tailed Deer', description: "Common in the park's forests and meadows.", rarity: 'Common' },
  { id: 'mount-rainier-mountain-lion', parkId: 'mount-rainier', name: 'Mountain Lion', description: "Elusive predator of the park's dense forest.", rarity: 'Rare' },
  { id: 'mount-rainier-gray-jay', parkId: 'mount-rainier', name: 'Gray Jay', description: 'Bold bird often seen at high-elevation trailheads.', rarity: 'Common' },
  ...
  { id: 'north-cascades-hoary-marmot', parkId: 'north-cascades', name: 'Hoary Marmot', description: "Whistles from rockslides in the park's high country.", rarity: 'Common' },
  { id: 'north-cascades-wolverine', parkId: 'north-cascades', name: 'Wolverine', description: 'Rare, elusive predator of the remote alpine.', rarity: 'Rare' },
  { id: 'north-cascades-golden-eagle', parkId: 'north-cascades', name: 'Golden Eagle', description: 'Soars above high mountain passes.', rarity: 'Uncommon' },
  ...
  { id: 'crater-lake-mule-deer', parkId: 'crater-lake', name: 'Mule Deer', description: 'Common in meadows and forests surrounding the caldera.', rarity: 'Common' },
  { id: 'crater-lake-osprey', parkId: 'crater-lake', name: 'Osprey', description: "Fishes in the park's rivers and creeks.", rarity: 'Uncommon' },
  { id: 'crater-lake-peregrine-falcon', parkId: 'crater-lake', name: 'Peregrine Falcon', description: "Nests on the caldera's steep cliffs.", rarity: 'Rare' },
  ...
  { id: 'haleakala-monarch-butterfly', parkId: 'haleakala', name: 'Monarch Butterfly', description: 'Seen fluttering among summit shrubs.', rarity: 'Uncommon' },
  { id: 'haleakala-house-finch', parkId: 'haleakala', name: 'House Finch', description: 'Common small bird near the visitor center.', rarity: 'Common' },
  { id: 'haleakala-feral-goat', parkId: 'haleakala', name: 'Feral Goat', description: "Introduced species found on the volcano's outer slopes.", rarity: 'Common' },
  ...
  { id: 'hawaii-volcanoes-apapane', parkId: 'hawaii-volcanoes', name: "'Apapane", description: 'Small red honeycreeper common in native ohia forest.', rarity: 'Common' },
  { id: 'hawaii-volcanoes-happy-face-spider', parkId: 'hawaii-volcanoes', name: 'Happy Face Spider', description: 'Tiny spider endemic to Hawaii, found on native plants.', rarity: 'Rare' },
  { id: 'hawaii-volcanoes-omao', parkId: 'hawaii-volcanoes', name: "'Oma'o", description: 'Native thrush found in the park\'s upland rainforest.', rarity: 'Uncommon' },
  ...
  { id: 'national-park-samoa-giant-clam', parkId: 'national-park-samoa', name: 'Giant Clam', description: "Found within the park's coral reefs.", rarity: 'Uncommon' },
  { id: 'national-park-samoa-parrotfish', parkId: 'national-park-samoa', name: 'Pacific Parrotfish', description: 'Brightly colored reef fish seen while snorkeling.', rarity: 'Common' },
  { id: 'national-park-samoa-white-tern', parkId: 'national-park-samoa', name: 'White Tern', description: 'Seabird that nests in coastal trees.', rarity: 'Uncommon' },
  ...
  { id: 'denali-golden-eagle', parkId: 'denali', name: 'Golden Eagle', description: "Nests on cliffs throughout the park's tundra.", rarity: 'Uncommon' },
  { id: 'denali-arctic-ground-squirrel', parkId: 'denali', name: 'Arctic Ground Squirrel', description: 'Common prey species seen along the park road.', rarity: 'Common' },
  { id: 'denali-wolverine', parkId: 'denali', name: 'Wolverine', description: 'Rare, elusive predator of the remote tundra.', rarity: 'Rare' },
  ...
  { id: 'katmai-arctic-tern', parkId: 'katmai', name: 'Arctic Tern', description: 'Migratory seabird nesting near Brooks Camp.', rarity: 'Uncommon' },
  { id: 'katmai-caribou', parkId: 'katmai', name: 'Caribou', description: "Migrates through the park's tundra valleys.", rarity: 'Uncommon' },
  { id: 'katmai-wolverine', parkId: 'katmai', name: 'Wolverine', description: 'Rare, elusive predator of the remote backcountry.', rarity: 'Rare' },
  ...
  { id: 'kenai-fjords-black-bear', parkId: 'kenai-fjords', name: 'Black Bear', description: 'Forages the coastal forest near Exit Glacier.', rarity: 'Uncommon' },
  { id: 'kenai-fjords-dall-porpoise', parkId: 'kenai-fjords', name: "Dall's Porpoise", description: 'Fast-swimming porpoise seen in the fjords.', rarity: 'Uncommon' },
  { id: 'kenai-fjords-bald-eagle', parkId: 'kenai-fjords', name: 'Bald Eagle', description: 'Nests along the rugged coastline.', rarity: 'Common' },
  ...
  { id: 'kobuk-valley-beaver', parkId: 'kobuk-valley', name: 'Beaver', description: "Builds dams along the park's boreal waterways.", rarity: 'Common' },
  { id: 'kobuk-valley-arctic-fox', parkId: 'kobuk-valley', name: 'Arctic Fox', description: 'Occasionally seen on the tundra in its white winter coat.', rarity: 'Rare' },
  { id: 'kobuk-valley-golden-eagle', parkId: 'kobuk-valley', name: 'Golden Eagle', description: 'Nests on bluffs above the Kobuk River.', rarity: 'Uncommon' },
  ...
  { id: 'lake-clark-red-fox', parkId: 'lake-clark', name: 'Red Fox', description: "Dens near the park's lakeshores.", rarity: 'Uncommon' },
  { id: 'lake-clark-caribou', parkId: 'lake-clark', name: 'Caribou', description: "Migrates through the park's mountain valleys.", rarity: 'Uncommon' },
  { id: 'lake-clark-wolverine', parkId: 'lake-clark', name: 'Wolverine', description: 'Rare, elusive predator of the remote backcountry.', rarity: 'Rare' },
  ...
  { id: 'wrangell-st-elias-lynx', parkId: 'wrangell-st-elias', name: 'Canada Lynx', description: "Elusive predator of the park's boreal forest.", rarity: 'Rare' },
  { id: 'wrangell-st-elias-beaver', parkId: 'wrangell-st-elias', name: 'Beaver', description: "Found along the park's rivers and wetlands.", rarity: 'Common' },
  { id: 'wrangell-st-elias-arctic-ground-squirrel', parkId: 'wrangell-st-elias', name: 'Arctic Ground Squirrel', description: 'Common in alpine meadows.', rarity: 'Common' },
  ...
  { id: 'gates-arctic-moose', parkId: 'gates-arctic', name: 'Moose', description: 'Found browsing willow thickets in remote river valleys.', rarity: 'Uncommon' },
  { id: 'gates-arctic-arctic-fox', parkId: 'gates-arctic', name: 'Arctic Fox', description: 'Occasionally seen hunting across the open tundra.', rarity: 'Rare' },
  { id: 'gates-arctic-golden-eagle', parkId: 'gates-arctic', name: 'Golden Eagle', description: 'Nests on remote cliffs throughout the Brooks Range.', rarity: 'Uncommon' },
];
