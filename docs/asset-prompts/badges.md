...
**Base style block** (also referenced by [unlockable-pals.md](unlockable-pals.md) for the sticker half of each unlockable):
...
Files live in `src/assets/badges/badge-<badge-id>.png`.

Badges tied to an unlockable Park Pal (Island Fox, Puffin, and future ones) have their prompts in [unlockable-pals.md](unlockable-pals.md) next to the pal art, so both halves are written together.
...
| acadia-puffin | Puffin Pal | an Atlantic Puffin on a rocky coastal outcrop (see unlockable-pals.md) |
